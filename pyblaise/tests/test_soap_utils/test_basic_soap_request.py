...
@pytest.mark.parametrize("host_info", host_infos)
def test__do_soap_request_raises_ServerConnectionError_on_requests_ConnectError(host_info, requests_mock):
    requests_mock.register_uri("POST", host_info["uri"], exc=requests.exceptions.ConnectionError)
...
@pytest.mark.parametrize("host_info", host_infos)
def test__do_soap_request_raises_ServerConnectionTimeout_on_requests_Timeout(host_info, requests_mock):
    requests_mock.register_uri("POST", host_info["uri"], exc=requests.exceptions.Timeout)
...
@pytest.mark.parametrize("host_info", host_infos)
def test__do_soap_request_raises_ServerConnectionTimeout_on_requests_ConnectTimeout(host_info, requests_mock):
    requests_mock.register_uri("POST", host_info["uri"], exc=requests.exceptions.ConnectTimeout)
